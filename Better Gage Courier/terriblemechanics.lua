...
function GageAssignmentTweakData:init(tweak_data)
	...
	self.assignments.green_mantis.aquire = 7 
	self.assignments.green_mantis.dlc = "gage_pack_jobs"
	self.assignments.green_mantis.rewards = big_list
	...
	self.assignments.yellow_bull.aquire = 7 
	self.assignments.yellow_bull.dlc = "gage_pack_jobs"
	self.assignments.yellow_bull.rewards = big_list
	...
	self.assignments.red_spider.aquire = 7 
	self.assignments.red_spider.dlc = "gage_pack_jobs"
	self.assignments.red_spider.rewards = big_list
	...
	self.assignments.blue_eagle.aquire = 7 
	self.assignments.blue_eagle.dlc = "gage_pack_jobs"
	self.assignments.blue_eagle.rewards = big_list
	...
	self.assignments.purple_snake.aquire = 7 
	self.assignments.purple_snake.dlc = "gage_pack_jobs"
	self.assignments.purple_snake.rewards = big_list 
end
